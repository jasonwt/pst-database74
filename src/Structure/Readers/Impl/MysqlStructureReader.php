...
namespace Pst\Database\Structure\Readers\Impl;
...
use Pst\Database\Connections\Impl\IMysqlConnection;

use Pst\Database\Structure\Readers\ISchemaReader;
use Pst\Database\Structure\Readers\Traits\SchemaReaderTrait;
...
class MysqlStructureReader extends CoreObject implements ISchemaReader {
    ...
    protected function implReadSchemas(?string $schemaName = null) {
        ...
        foreach ($queryResults as $schemaData) {
            ...
            $tables = $this->implReadTables($schemaData['schemaName']);
    ...
    protected function implReadTables(string $schemaName, ?string $tableName = null) {
        ...
        foreach ($queryResults as $tableData) {
            ...
            $columns = $this->implReadColumns($schemaName, $tableData['tableName']);
            $indexes = $this->implReadIndexes($schemaName, $tableData['tableName']);
